app.controller("displayTasksController", function ($scope, $http, $mdDialog) {

    $scope.getAllTasksForUser = function() {
        $http.get("/task/getTasks" + $scope.$parent.userId)
    ...
    $scope.addTask = function (task, status) {
        ...
        task.userId = $scope.$parent.userId;
